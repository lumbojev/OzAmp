...
OzAmp **1.0.1** is the stable release following **1.0.0**.
...
## Complete repository change inventory since v1.0.0
...
## Git changes already on main since v1.0.0

- Add native OzAmp application icon (005c993)
- Update README screenshot (18dcbd6)
- Polish GitHub presentation (a4aa7d4)
- Update GitHub banner and presentation (49761ec)
- Polish GitHub presentation (5ac9e7b)
- Polish GitHub presentation (73b5661)

The final release commit for **v1.0.1** is added by the updater after these notes are generated.
...
.github/workflows/build-windows.yml |    8 +-
 ...
 README.md                           |  111 +++-
 RELEASE_NOTES.md                    |   27 +-
 SECURITY_AND_PRIVACY.md             |   14 +-
 build_linux_cross.sh                |   22 +-
 build_windows_llvm.bat              |   17 +-
 docs/assets/ozamp-banner.png        |  Bin 0 -> 1621212 bytes
 docs/assets/ozamp-screenshot.png    |  Bin 0 -> 39472 bytes
 gdiplus.def                         |    6 +
 kernel32.def                        |    9 +
 main.cpp                            | 1218 +++++++++++++++++++++++++++++++----
 ozamp-icon.png                      |  Bin 0 -> 1207085 bytes
 ozamp.ico                           |  Bin 0 -> 142049 bytes
 ozamp.rc                            |    2 +
 ozamp.res                           |  Bin 0 -> 142336 bytes
 resource.h                          |    2 +
 shell32.def                         |    1 +
 tools/make_icon_res.py              |   44 ++
 user32.def                          |    4 +
 winlite.h                           |  106 +++
 24 files changed, 1495 insertions(+), 180 deletions(-)
```

## Distribution

- Windows x64 executable: `OzAmp-1.0.1.exe`
- SHA-256 checksum: `OzAmp-1.0.1-SHA256.txt`
- Source snapshot: `OzAmp-1.0.1-source.zip`
- Source tag: `v1.0.1`
